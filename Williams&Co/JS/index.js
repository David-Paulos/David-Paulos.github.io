...
const salesRedirect = document.getElementById('main__buy-rent__sales-section__inner-section')
const lettingsRedirect = document.getElementById('main__buy-rent__lettings-section__inner-section')
...
homeButton.addEventListener('click', () => window.scrollTo(0,0))
...
salesRedirect.addEventListener('click', () => window.location.href = "./sales/sales.html")

lettingsRedirect.addEventListener('click', () => window.location.href = "./lettings/lettings.html")

phoneRedirect .addEventListener('click', () => window.location.href = "tel:123456789")

emailRedirect.addEventListener('click', () => window.location.href = "mailto:info@williamsandco.com") 
